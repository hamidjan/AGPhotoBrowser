...
- (void)tableView:(UITableView *)tableView willDisplayCell:(UITableViewCell *)cell forRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    _selectedZoomable = [(UITableViewCell<AGPhotoBrowserCellProtocol> *)cell getZoomable];
}
...
{
    if ([_delegate respondsToSelector:@selector(photoBrowser:didSelectZoomable:)]) {
        UITableViewCell *cell = [_photoTableView cellForRowAtIndexPath:[NSIndexPath indexPathForRow:_currentlySelectedIndex inSection:0]];
        _selectedZoomable = [(UITableViewCell<AGPhotoBrowserCellProtocol> *)cell getZoomable];
        [_delegate photoBrowser:self didSelectZoomable:_selectedZoomable];
    }
}
